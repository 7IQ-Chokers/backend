...
createMongoConnection(mongoURI)
  .then((connection) => {
    global.User = connection.model("User", require("./models/userModel"));
    global.Proposal = connection.model(
      "Proposal",
      require("./models/proposalModel")
    );
    global.Project = connection.model(
      "Project",
      require("./models/projectModel")
    );
    global.Problem = connection.model(
      "Problem",
      require("./models/problemModel")
    );
    global.Organization = connection.model(
      "Organization",
      require("./models/organizationModel")
    );
    global.Investment = connection.model(
      "Investment",

...
const processLocation = async (problem) => {
  ...
  let response = await axios.post(
    `https://geocode.maps.co/reverse?lat=${location["coordinates"]["latitude"]}&lon=${location["coordinates"]["longitude"]}&api_key=663fb43306219517704421locfce31f`
  );
...
// FIXME: Ask for Tags from current system available tags
